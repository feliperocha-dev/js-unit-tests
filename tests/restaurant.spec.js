...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    let object = {};
    let outputObject = createMenu(object);
    assert.strictEqual(typeof createMenu(object), 'object');
    //assert.deepStrictEqual(outputObject, { fetchMenu: object }); Este teste se tornou obsoleto
    ...
    // ```
    object = {food: {}, drink: {}};
    outputObject = createMenu(object);
    assert.deepStrictEqual(outputObject.fetchMenu, {food: {}, drink: {}});
    ...
    // ```
    assert.deepStrictEqual(outputObject.fetchMenu, object);
    ...
    // ```
    assert.deepStrictEqual(outputObject.consumption, []);
    ...
    assert.deepStrictEqual(outputObject.consumption, ['coxinha']);
    ...
    assert.deepStrictEqual(outputObject.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    // ```
    ...
    outputObject.order('agua');
    outputObject.order('coxinha');
    assert.deepStrictEqual(outputObject.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    object = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    outputObject = createMenu(object);
    outputObject.order('coxinha');
    outputObject.order('agua');
    outputObject.order('coxinha');
    assert.strictEqual(outputObject.pay(), 11.7);
